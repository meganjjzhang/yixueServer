				...
				<div class="table-b">
					<form id="login" action="LoginServlet" method="post">
						<table border="0" cellpadding="10" cellspacing="2">
							<tr>
								<td><label for="admin_number">学号</label></td>
								<td><input type="text" class="inputStyle" id="admin_number" name="admin_number"><br></td>
							</tr>
							<tr>
...
<script type="text/javascript">
	function check(){
		var adm = document.getElementById("admin_number").value;
		...
		if(stu.length==0){
			...
			var url = "LoginServlet?admin_number="+adm+"&password="+pas;
