...
<%		response.setHeader("refresh", "1;URL=Slogin.jsp");
	}else{
				...
				<div class="table-b">
					<form id="login" action="LoginServlet" method="post">
						<table border="0" cellpadding="10" cellspacing="2">
							<tr>
								<td><label for="student_number">学号</label></td>
								<td><input type="text" class="inputStyle" id="student_number" name="student_number"><br></td>
							</tr>
							<tr>
...
<script type="text/javascript">
	function check(){
		var stu = document.getElementById("student_number").value;
		...
		if(stu.length==0){
			...
			var url = "LoginServlet?student_number="+stu+"&password="+pas;
