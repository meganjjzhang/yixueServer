...
public class StudentDao {	/*学生登录验证*/

	public static String login(String student_number, String password) {
		...
		try {
			pstmt = con.prepareStatement("select student_name from students where student_number=? and password=?");
